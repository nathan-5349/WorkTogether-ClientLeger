 ...
 */
final class Version20260227142426 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE bay (id INT AUTO_INCREMENT NOT NULL, capacity_unit INT NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE offer (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(100) NOT NULL, nb_unit INT NOT NULL, price INT NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE ticket (id INT AUTO_INCREMENT NOT NULL, subject VARCHAR(50) NOT NULL, description LONGTEXT NOT NULL, open_date DATETIME NOT NULL, close_date DATETIME NOT NULL, status VARCHAR(255) NOT NULL, user_id INT NOT NULL, INDEX IDX_97A0ADA3A76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE unit (id INT AUTO_INCREMENT NOT NULL, position INT NOT NULL, name VARCHAR(30) NOT NULL, status VARCHAR(255) NOT NULL, bay_id INT NOT NULL, INDEX IDX_DCBB0C53DF9BA23B (bay_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
